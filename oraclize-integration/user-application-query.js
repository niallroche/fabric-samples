...
Fabric_Client.newDefaultKeyValueStore({ path: store_path
	...
	console.log("about to finish initial callback")
	...
	//const request = { chaincodeId: "user-chaincode", fcn: "fetchComputeviaOraclize", args: [] }
	...
	console.log(query_responses[0].length)
